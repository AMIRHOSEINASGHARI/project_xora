        ...
        <div className="container-base">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {features.map(({ id, button, caption, icon, text, title }) => (
              <div
                key={id}
                className="relative z-2 md:px-10 px-5 md:pb-10 pb-5 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl flex-50 max-md:flex-320"
              >
            ...
            <ul className="relative flex justify-around w-full px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
